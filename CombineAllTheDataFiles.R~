...
write.csv(vaers_data, paste0(firstYear, "-", lastYear, "_vaers_symptoms.csv"),  row.names = FALSE)
write.csv(vaers_data, paste0(firstYear, "-", lastYear, "_vaers_vax.csv"),  row.names = FALSE)
